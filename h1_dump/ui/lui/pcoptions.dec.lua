...
LUI.PCGraphicOptions.LoadMenu = function ( f2_arg0, f2_arg1, f2_arg2 )
	LUI.FlowManager.RequestAddMenu( f2_arg0, LUI.PCGraphicOptions.Categories[f2_arg2].menuType, true, f2_arg1.controller, true )
...
LUI.PCControlOptions.LoadMenu = function ( f5_arg0, f5_arg1, f5_arg2 )
	LUI.FlowManager.RequestAddMenu( f5_arg0, LUI.PCControlOptions.Categories[f5_arg2].menuType, true, f5_arg1.controller, true )
	CoD.PlayEventSound( CoD.SFX.H1TabChange, 10 )
end
...
function SetDvarValue( f11_arg0, f11_arg1 )
	...
	elseif Engine.GetDvarType( f11_arg0 ) == DvarTypeTable.DvarString then
		...
		DebugPrint( "WARNING: Unsupported SetDvarValue type " .. tostring( Engine.GetDvarType( f11_arg0 ) ) .. " for dvar " .. f11_arg0 )
	end
end
...
function GetDvarValue( f12_arg0 )
	...
	elseif Engine.GetDvarType( f12_arg0 ) == DvarTypeTable.DvarString then
		...
		DebugPrint( "WARNING: Unsupported GetDvarValue type " .. tostring( Engine.GetDvarType( f12_arg0 ) ) .. " for dvar " .. f12_arg0 )
		return ""
	end
end
...
function TransferSettingsToGame()
...
LUI.MenuBuilder.registerType( "pc_controls", LUI.PCOptionsMenu.new )
if Engine.InFrontend() and Engine.IsMultiplayer() then
	VLobby.InitMenuMode( "pc_controls", VirtualLobbyModes.LUI_MODE_OBSCURED )
end
LockTable( _M )
