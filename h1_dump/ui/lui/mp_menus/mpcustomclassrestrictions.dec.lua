...
PrimaryData.SubtypeData[PrimaryData.Subtype.Shotgun] = {
	SubKey = "weapon_shotgun",
...
Cac.Restrict.CategData[Cac.Restrict.Categ.AttachBase] = {
	CategKey = "Primary_AttachmentBase",
	ActionText = "@LUA_MENU_RESTRICT_ATTACHMENT",
	MenuTitle = "@LUA_MENU_RESTRICTIONS_ATTACHMENT_CAPS",
	Subtype = {
		Rail = 1,
		Barrel = 2,
		Undermount = 3
...
AttachData = Cac.Restrict.CategData[Cac.Restrict.Categ.AttachBase]
AttachData.SubtypeData[AttachData.Subtype.Rail] = {
	SubKey = "rail",
	Label = "@LUA_MENU_ATTACHTYPE_RAIL"
}
AttachData.SubtypeData[AttachData.Subtype.Barrel] = {
	SubKey = "barrel",
	Label = "@LUA_MENU_ATTACHTYPE_BARREL"
}
AttachData.SubtypeData[AttachData.Subtype.Undermount] = {
	SubKey = "undermount",
	Label = "@LUA_MENU_ATTACHTYPE_UNDERMOUNT"
}
...
function GetItemList( f2_arg0, f2_arg1 )
	...
	if f2_arg0 == Cac.Restrict.Categ.AttachBase then
		return Cac.GetAttachmentBaseByGroup( f2_local1 )
	end
...
LUI.MenuBuilder.registerType( "ClassRestrictMenu", ClassRestrictMenu )
LockTable( _M )
